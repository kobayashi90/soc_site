...
const mailConfig = JSON.parse(process.env.MAIL)
const transporter = nodemailer.createTransport(mailConfig)

export const createForgor = async (user, db) => {
  return db.transaction(async () => {
    ...
    const html = template.replaceAll('{{forgor_link}}', `https://beta.sittingonclouds.net/forgor?key=${key}`)
                            ...
                            <tr>
                              <td
                                ...
                                <div align='center' style='line-height:10px'><img
                                    alt='reset-password' src='https://beta.sittingonclouds.net/img/assets/clouds.png'
